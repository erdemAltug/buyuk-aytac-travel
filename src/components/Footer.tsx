...
export default function Footer() {
  ...
  const socialLinks: SocialIcon[] = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/people/B%C3%9CY%C3%9CK-AYTA%C3%87-Travel/61581407056598/',
      icon: ({ className }) => (
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-6 md:mt-0">
            <ul className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <li className="mb-2 mx-1">
                <a href="/admin/login" className="text-gray-400 hover:text-white transition-colors duration-300 px-2 py-1">Yönetici Girişi</a>
              </li>
            </ul>
          </div>
        </div>
