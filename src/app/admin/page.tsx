      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-700">Destinasyonlar</h2>
                <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">8 Destinasyon</span>
              </div>
              <p className="text-gray-600 mb-4">Sistemde kayıtlı destinasyon sayısı</p>
              <Link href="/admin/destinations" className="text-blue-600 hover:text-blue-800 font-medium text-sm">
                Destinasyonları Yönet &rarr;
              </Link>
            </div>
