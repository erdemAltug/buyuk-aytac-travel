...
// Blog yazısı oluşturmak için API isteği
...
export default function NewBlogPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 4. Başarı durumunda bloglar sayfasına yönlendir
      router.push('/admin/blogs');
      
    } catch (err) {
      console.error('Blog oluşturma hatası:', err);
      setError('Blog oluşturulurken bir hata oluştu: ' + (err instanceof Error ? err.message : 'Bilinmeyen hata'));
      setSubmitting(false);
    }
  };
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  required
                ></textarea>
                <p className="mt-1 text-xs text-gray-500">Blog listesinde görünecek kısa bir açıklama (max. 200 karakter)</p>
              </div>
              ...
              <div className="mb-6">
                ...
                {formData.imageUrl && (
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 mb-2">Görsel Önizleme:</p>
                    <img
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  ...
                  disabled={submitting}
                >
                  {submitting ? 'Kaydediliyor...' : 'Blog Ekle'}
                </button>
              </div>
            </form>
          </div>
